...
public class VoiceMathGameClassic : MonoBehaviour
{
    [Header("UI")]
    public TextMeshProUGUI QuestionText;
    public TextMeshProUGUI StatusText;
    public TextMeshProUGUI ResultText;
    public TextMeshProUGUI ScoreText;  // now shows "Score x/y (y of maxQuestions)"
    ...
    private char op;
    private int score = 0, total = 0; // total = questions attempted so far
    ...
    {
        // If we already hit the question cap, end the run.
    ...
    {
        // Count this question and a life loss
        RunStats.RecordAnswer(false);
        total++;
        ...
        // End if out of lives or reached question cap
